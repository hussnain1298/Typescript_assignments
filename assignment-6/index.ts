...
const personName2:string = "Ali Hussnain";
...
let message:string="Take risks now. Do something bold. You won't regret it.";
...
const userNames:string[] = ['ali' , 'Affan' , 'Babar' , 'Naseem','Shaheen','Rauf']
...
const usernames:string[] = ['admin' , 'Ali' , 'Babar' , 'Naseem','Shaheen','Rauf']
